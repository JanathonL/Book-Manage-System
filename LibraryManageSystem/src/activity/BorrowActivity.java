...
public class BorrowActivity extends JFrame{
	private JTextField textField_cardNumber;
	private JTextField textField_bookNumber;
	static String administratorId;
	JTextArea textArea,txtrResult_1;
	class MyBorrowOK implements ActionListener{
			...
			if(e.getActionCommand().equals("cardConfirm")){
				...
				try {
					if(bookborrow.Isok()==true){
						bookborrow.borrowTheBook(textArea);
					}
					else{
					...
					// TODO Auto-generated catch block
					System.out.println("bookborrowIsok failed");
					e1.printStackTrace();
				}
			}
		}
	...
	public BorrowActivity(String administratorId) {
		this.administratorId=administratorId;
		getContentPane().setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setBounds(66, 27, 447, 34);
	//	getContentPane().add(panel);
		...
		btnOk.addActionListener(new MyBorrowOK());
		panel.add(btnOk);
		
		JLabel label_1 = new JLabel("\u5DF2\u501F\u4E66\u7C4D");
		label_1.setBounds(66, 70, 54, 15);
//		getContentPane().add(label_1);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(66, 200, 447, 34);
	//	getContentPane().add(panel_1);
		...
		btnOk_1.addActionListener(new MyBorrowOK());
		panel_1.add(btnOk_1);
		
		textArea = new JTextArea();
		textArea.setEditable(false);
		textArea.setText("result");
		textArea.setBounds(66, 244, 447, 107);
	//	getContentPane().add(textArea);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(66, 100, 447, 87);
...
//		layeredPane.add(scrollPane, JLayeredPane.MODAL_LAYER);
		...
		run(this,600,400,"BorrowActivity");
	}
